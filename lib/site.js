export const site = {
  name: 'Still Relevantt',
  founder: 'Temi Olajide',
  tagline: 'AI is changing the world. Still Relevantt helps you understand where you fit in.',
  strapline: 'AI made simple',
  url: 'https://stillrelevantt.com',
  description:
    'Still Relevantt helps adults 40+ discover practical ways to use AI in everyday life, work and new opportunities, so they can stay confident, capable and relevant as the world changes.',
  phone: '+44 7950 735340',
  phoneHref: 'tel:+447950735340',
  // Public contact address. Squarespace forwarding rule on stillrelevantt.com,
  // delivering to stillrelevantt@gmail.com. Also the reply-to on every email
  // the brand sends, so people replying to a newsletter and people emailing
  // from the site land in the same inbox.
  email: 'hello@stillrelevantt.com',
  emailHref: 'mailto:hello@stillrelevantt.com',
  // Where the CONTACT form posts. Formspree, emailing every message straight to
  // stillrelevantt@gmail.com. Set this back to null and the form returns to
  // safe mode: it validates, sends nowhere, and tells visitors to WhatsApp instead
  // rather than thanking them for a message nobody received.
  formEndpoint: 'https://formspree.io/f/mnpqvzzj',
  // Where the free-guide signups post. MailerLite embedded form, feeding the
  // "Still Relevant Community" group with double opt-in on, so nobody joins the
  // list without confirming. This is a public endpoint by design, no key in here.
  newsletterEndpoint:
    'https://assets.mailerlite.com/jsonp/2249040/forms/197539198445552738/subscribe',
  ...
  social: [
    { label: 'YouTube', href: 'https://www.youtube.com/@Stillrelevantt' },
    { label: 'Instagram', href: 'https://www.instagram.com/stillrelevantt' },
    { label: 'LinkedIn', href: 'https://www.linkedin.com/in/temiolajide/' },
    { label: 'Facebook', href: 'https://www.facebook.com/stillrelevantt' },
  ],
