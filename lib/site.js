export const site = {
  ...
  // Where the CONTACT form posts. Leave null and it stays in safe mode: the form
  // validates and shows real states, but sends nowhere, and visitors are told to
  // WhatsApp instead rather than being thanked for a message nobody received.
  formEndpoint: null,
